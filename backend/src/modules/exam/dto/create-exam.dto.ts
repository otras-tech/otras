...
export class CreateExamDto {
  ...
  @ApiPropertyOptional({
    example: 'Graduation in any discipline',
  ...
  @ApiPropertyOptional({
    example: '100 Questions, 60 Minutes',
    description: 'Exam pattern details',
  })
  @IsString()
  @IsOptional()
  pattern?: string;
  ...
  @ApiPropertyOptional({
    example: [1, 2],
    description: 'List of Subject IDs to associate',
  })
  @IsOptional()
  @IsNumber({}, { each: true })
  subjectIds?: number[];
