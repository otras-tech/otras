import { IsNumber, IsOptional, IsString, IsNotEmpty, IsObject } from 'class-validator';
...
export class SubmitMockAttemptDto {
  ...
  @ApiPropertyOptional({ example: 123, description: 'Optional: ID of the attempt from /start-attempt' })
  @IsOptional()
  @IsNumber()
  attemptId?: number;
}
...
export class SubmitExamAttemptDto {
  ...
  @ApiPropertyOptional({ example: 15, description: 'Number of correct answers' })
  @IsOptional()
  @IsNumber()
  correctAnswers?: number;

  @ApiPropertyOptional({ example: { "Quant": 10, "Logical": 5 }, description: 'JSON string or object for breakdown' })
  @IsOptional()
  @IsObject()
