...
export interface RoadmapResponse {
  roadmap: {
    ...
    sixMonth: { month: string; tasks: string[] }[];
    oneYear: { phase: string; tasks: string[] }[];
  };
}
...
export class CareerAIService {
  ...
  async generateRoadmap(dto: CreateRoadmapDto): Promise<RoadmapResponse> {
    ...
    try {
      ...
      this.logger.error(`CareerAI Backend Error: ${(error as Error).message}`);

      // Production-grade fallback with individual 6-month structure
      return {
        roadmap: {
          summary:
            'AI systems are currently under high load. We have generated a foundational success trajectory based on your scores to get you started immediately.',
          recommendations: [
          ...
          sixMonth: [
            {
              ...
              tasks: [
                ...
                'Complete initial Tier 1 review',
            ...
            },
            {
              month: 'Month 3',
              tasks: [
                'Deep dive into verbal ability',
                'Analyze mock test patterns',
                'Strategy iteration',
              ],
            },
            {
              ...
              tasks: [
                ...
                'Identify second-tier weaknesses',
            ...
            },
            {
              month: 'Month 5',
              tasks: [
                'Full-length mock marathon',
                'Review exam day strategy',
                'Speed optimization',
              ],
            },
            {
