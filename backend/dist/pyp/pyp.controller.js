...
Object.defineProperty(exports, "PypController", {
    enumerable: true,
    get: function() {
        return PypController;
    }
});
...
PypController = _ts_decorate([
    (0, _common.Controller)('pyps'),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _pypservice.PypService === "undefined" ? Object : _pypservice.PypService
    ])
], PypController);
