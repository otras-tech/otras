...
const artha_processor_1 = require("./processor/artha.processor");
...
exports.ArthaModule = ArthaModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            artha_service_1.ArthaService,
            artha_repository_1.ArthaRepository,
            tier3_metrics_service_1.Tier3MetricsService,
            artha_processor_1.ArthaProcessor,
            ...(process.env.DISABLE_REDIS === 'true'
                ? [
                    {
