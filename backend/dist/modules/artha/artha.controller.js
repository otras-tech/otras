...
let ArthaController = class ArthaController {
    ...
    async getStatus(userId, req) {
        return this.service.getStatus(req.user.id, req.user.otrId, req.user.role, userId);
    }
    async startTier(body, tier, req) {
        return this.service.startTierAssessment(req.user.id, req.user.otrId, req.user.role, body.userId, tier);
    }
    async completeTier1(body, req) {
        return this.service.processTier1(req.user.id, req.user.otrId, req.user.role, body, body.assessmentId);
    }
    async completeTier2(body, req) {
        return this.service.processTier2(req.user.id, req.user.otrId, req.user.role, body.userId, body.assessmentId, body.language, body.attemptedCount, body.totalQuestions);
    }
    async completeTier3(body, req) {
        return this.service.processTier3(req.user.id, req.user.otrId, req.user.role, body.userId, body.assessmentId, body.language, body.attemptedCount, body.totalQuestions);
    }
    async attemptQuestion(body, req) {
        return this.service.recordQuestionAttempt(req.user.id, req.user.otrId, req.user.role, body);
    }
    async getRecentReports(userId, req) {
        return this.service.getStatus(req.user.id, req.user.otrId, req.user.role, userId);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [artha_tier_dto_1.StartTierDto, Number, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [artha_tier_dto_1.ArthaTierResultDto, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [artha_tier_dto_1.ArthaQuestionAttemptDto, Object]),
    __metadata("design:returntype", Promise)
