...
Object.defineProperty(exports, "ArthaService", {
    enumerable: true,
    get: function() {
        return ArthaService;
    }
...
let ArthaService = class ArthaService {
    ...
    async recordQuestionAttempt(data) {
        ...
        if (assessment) {
            ...
            const progress = totalQuestionsInTier > 0 ? Math.min(100, Math.round(attemptedCount / totalQuestionsInTier * 100)) : 0;
    ...
    async processTier1(data, assessmentId) {
        ...
        const readinessIndex = await this.calculateReadiness(data.userId.toString(), 1, {
    ...
    constructor(repository, metricsService){
        ...
        this.logger = new _common.Logger(ArthaService.name);
        this.ML_SERVICE_URL = process.env.ML_SERVICE_URL || 'http://127.0.0.1:5000';
        this.AI_SERVICE_URL = process.env.AI_SERVICE_URL || 'http://localhost:8000/api/v1';
    }
};
ArthaService = _ts_decorate([
    (0, _common.Injectable)(),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _artharepository.ArthaRepository === "undefined" ? Object : _artharepository.ArthaRepository,
        typeof _tier3metricsservice.Tier3MetricsService === "undefined" ? Object : _tier3metricsservice.Tier3MetricsService
    ])
], ArthaService);
