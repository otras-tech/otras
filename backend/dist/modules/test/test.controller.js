...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all available tests' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get details of a specific test' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)('ADMIN'),
    (0, swagger_1.ApiOperation)({ summary: 'Update test metadata (Admin only)' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
...
exports.TestController = TestController = __decorate([
    (0, swagger_1.ApiTags)('Mock Tests (Full Exams)'),
