...
let AppModule = AppModule_1 = class AppModule {
    ...
    constructor(configService) {
        ...
        const accessSecret = this.configService.get('JWT_ACCESS_SECRET') || this.configService.get('jwt.accessSecret');
    ...
    configure(consumer) {
        consumer
            ...
            if (auth)
                console.log(`[AUTH-DEBUG] Prefix: ${auth.substring(0, 15)}...`);
            next();
        })
            .forRoutes('*');
            ...
            cache_manager_1.CacheModule.registerAsync({
                ...
                useFactory: async (config) => {
                    ...
                    try {
                        ...
                        console.warn('⚠️ CacheModule: Redis Cache failed to initialize, falling back to memory store', err instanceof Error ? err.message : err);
                        return { ttl: 600 };
                    }
                },
            }),
