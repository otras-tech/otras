...
Object.defineProperty(exports, "MockTestModule", {
    enumerable: true,
    get: function() {
...
const _mocktestcontroller = require("./mock-test.controller");
...
MockTestModule = _ts_decorate([
    (0, _common.Module)({
        imports: [
            _prismamodule.PrismaModule
        ],
        controllers: [
            _mocktestcontroller.MockTestController
        ],
        providers: [
