...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 2023, description: 'The year of the previous year paper' }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", Number)
], CreatePypDto.prototype, "year", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'https://example.com/ssc-cgl-2023.pdf', description: 'URL to the PDF file' }),
