...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Pro Monthly Plan', description: 'Title of the subscription plan' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: ['Unlimited Mock Tests', 'AI Career Roadmap', 'Ad-free Experience'], description: 'List of features' }),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.IsString)({ each: true }),
    __metadata("design:type", Array)
], CreateSubscriptionDto.prototype, "features", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: true, description: 'Whether this plan is highlighted as recommended' }),
