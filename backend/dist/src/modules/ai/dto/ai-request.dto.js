...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 70, description: 'Quantitative aptitude score' }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: ['Tech', 'Management'], description: 'User interests' }),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.IsString)({ each: true }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Array)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Visual', description: 'User learning pattern' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], AiRequestDto.prototype, "learningPattern", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'IAS Officer', description: 'User aspirations' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
