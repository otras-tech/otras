        ...
        if (this.configService.get('DISABLE_REDIS') === 'true') {
            process.nextTick(async () => {
                try {
                    ...
                    const summary = typeof simulatedResponse === 'string' ? simulatedResponse : simulatedResponse.summary || "Generated roadmap";
                    const recommendations = simulatedResponse.recommendations && Array.isArray(simulatedResponse.recommendations) ? simulatedResponse.recommendations : [];
