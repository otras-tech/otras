...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'ID of the user who is referring' }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", Number)
], CreateReferralDto.prototype, "referrerId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'OTR123456', description: 'OTR ID of the user being referred' }),
