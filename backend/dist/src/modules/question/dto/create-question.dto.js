...
__decorate([
    (0, swagger_1.ApiProperty)({ example: ['London', 'Paris', 'Berlin', 'Madrid'], description: 'List of options' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Paris is the capital and largest city of France.', description: 'Brief explanation' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateQuestionDto.prototype, "explanation", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'ID of the Subject this question belongs to' }),
