...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'User registered and logged in with access and refresh tokens' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad Request - Validation or conflict' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User validated, returns JWT Access and Refresh Tokens' }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Rotate and exchange a valid refresh token for a new set of tokens' }),
