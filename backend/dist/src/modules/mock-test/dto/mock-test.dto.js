...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 123, description: 'Optional: ID of the attempt from /start-attempt' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 15, description: 'Number of correct answers' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], SubmitExamAttemptDto.prototype, "correctAnswers", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: { "Quant": 10, "Logical": 5 }, description: 'JSON string or object for breakdown' }),
    (0, class_validator_1.IsOptional)(),
